<script setup lang="ts">
    ...
    watch(() => popupState.value.isOpen, async (isOpen) => {
        if (isOpen && popupState.value.popupType === 'event') {
            await nextTick()
...
<template>
    <Transition name="popup-slide-up">
        <dialog v-if="popupState.isOpen && popupState.popupType === 'event'" ref="popupRef" class="popup-content" @scroll="checkScroll">
